...
pub enum Error {
  ...
  NotMainThread,
  #[cfg(target_os = "macos")]
  #[error("the native parent view is temporarily detached from its window")]
  DetachedParentView,
  #[cfg(target_os = "macos")]
  #[error("an Objective-C exception was contained during native webview work")]
  ObjectiveCException,
  #[cfg(target_os = "macos")]
  #[error("a Rust panic was contained during native webview work")]
  NativeCallbackPanicked,
